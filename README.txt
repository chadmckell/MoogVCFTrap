...
This is a virtual analog model of the Moog voltage-controlled filter. The state-space system is solved using the trapezoidal integration rule. The approximated transfer function is compared with the exact calculation of the Moog VCF transfer function. 
