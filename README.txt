...
A preliminary C++ implemenation of the MATLAB algorithm is included in the file "PluginProcessor.cpp" in the C++ folder. An accompanying JUCE project will be uploaded soon that will allow you to use the C++ code to build your own real-time VST plugin of the Moog VCF. Stay tuned!
