This code is designed for beginners to C++ and/or physical modeling. For this reason, it does not include more complicated features such as sidechain modulation, parameter interpolation, pausing, or any computation of nonlinear functions. In addition, I chose not to use the Eigen C++ library because I didn't want it to be a hurdle to beginners (you'll notice that I compute the matrix inverse by hand).
