...
class MoogVcftrapAudioProcessorEditor::ParameterSlider   : public Slider,
private Timer
{
public:
...
//==============================================================================
MoogVcftrapAudioProcessorEditor::MoogVcftrapAudioProcessorEditor (MoogVcftrapAudioProcessor& owner)
...
MoogVcftrapAudioProcessorEditor::~MoogVcftrapAudioProcessorEditor()
{
}

//==============================================================================
void MoogVcftrapAudioProcessorEditor::paint (Graphics& g)
{
    g.setColour (backgroundColour);
    g.fillAll();
}

void MoogVcftrapAudioProcessorEditor::resized()
{
...
//==============================================================================
void MoogVcftrapAudioProcessorEditor::timerCallback()
{
    updateTimecodeDisplay (getProcessor().lastPosInfo);
}

void MoogVcftrapAudioProcessorEditor::hostMIDIControllerIsAvailable (bool controllerIsAvailable)
{
    midiKeyboard.setVisible (! controllerIsAvailable);
}

void MoogVcftrapAudioProcessorEditor::updateTrackProperties ()
{
...
void MoogVcftrapAudioProcessorEditor::updateTimecodeDisplay (AudioPlayHead::CurrentPositionInfo pos)
{
