     ...
     : AudioProcessor (getBusesProperties())
{
    ...
    addParameter (resParam  = new AudioParameterFloat ("resonance",  "Res Freq", 0.0f, 1.0f, 0.5f));
...
void MoogVcftrapAudioProcessor::applyMoog (AudioBuffer<FloatType>& buffer)
{
    ...
    f0 = 1000*f0;
    float r = 0.5f; // tuning parameter, i.e. "resonance" (a number between 0 and 1)
    const float pi = 3.1415926536; // constant value of pi
